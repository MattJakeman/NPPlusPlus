...
/*
* NP++ : ICMPv6 Option Numbers
*/
#define ND_OPT_NP_NEGOTIATION 62
#define ND_OPT_NP_FINALISATION 63
 ...
 * NP++ Structs
 */
struct nd_opt_np_map
{
    guint8          nd_opt_npm_mapping;
    guint8          nd_opt_npm_prio;
};

struct nd_opt_np_map_adv
{
    guint8          nd_opt_npm_type;
    guint8          nd_opt_npm_length;
    guint8          nd_opt_npm_no_maps;
    struct nd_opt_np_map   *nd_opt_npm_maps;
};

#define NP_FIN_PAD_SIZE 5

struct nd_opt_np_fin
{
  guint8            nd_opt_npf_type;
  guint8            nd_opt_npf_length;
  guint8            nd_opt_npf_mapping;
  guint8            nd_opt_npf_pad[NP_FIN_PAD_SIZE];
};
